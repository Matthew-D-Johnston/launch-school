...
You can see our demo app [here](https://dbdwvr6p7sskw.cloudfront.net/js-exercises/mini_projects/forms/03_tab_forwarding/index.html). Play with the credit card inputs to get a better sense of how the form should work.  
...
<html lang="en-US">
  <head>
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" href="automatic_tab_forwarding.css">
    <script src="automatic_tab_forwarding.js"></script>
  </head>
  <body>
    <div>
    <h1>Sign up Form</h1>
